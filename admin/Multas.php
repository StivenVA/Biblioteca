    ...
    <table id="table" class="table table-striped" style="width:100%">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><button type="button" id="botontabla" class="btn btn-outline-success" data-bs-target="#modal"  data-bs-toggle="modal" data-titulo="<?php echo $mostrar->titulo; ?>" data-cod="<?php echo $mostrar->cod_ejem; ?>" data-user="<?php echo $mostrar->cod_usuario; ?>">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <select name='estado' id="est" class="form-select form-select-sm" aria-label=".form-select-sm example" required data-estado>
            ...
            <option value="Devuelto con retraso" >Retrasado </option>
          </select>
          </p>
      </div>
